...
class HolyMoley(TBase):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.LIST, 'big', (TType.STRUCT, (OneOfEach, OneOfEach.thrift_spec), False), None, ),  # 1
        (2, TType.SET, 'contain', (TType.LIST, (TType.STRING, 'UTF8', True), False), None, ),  # 2
        (3, TType.MAP, 'bonks', (TType.STRING, 'UTF8', TType.LIST, (TType.STRUCT, (Bonk, Bonk.thrift_spec), False), False), None, ),  # 3
    )
...
class RandomStuff(TBase):
    ...
    thrift_spec = (
        ...
        (6, TType.MAP, 'maps', (TType.I32, None, TType.STRUCT, (Wrapper, Wrapper.thrift_spec), False), None, ),  # 6
...
class CompactProtoTestStruct(TBase):
    ...
    thrift_spec = (
        ...
        (19, TType.LIST, 'struct_list', (TType.STRUCT, (Empty, Empty.thrift_spec), False), None, ),  # 19
        ...
        (28, TType.SET, 'struct_set', (TType.STRUCT, (Empty, Empty.thrift_spec), False), None, ),  # 28
...
class TestUnion(TBase):
    ...
    thrift_spec = (
        ...
        (4, TType.LIST, 'struct_list', (TType.STRUCT, (RandomStuff, RandomStuff.thrift_spec), False), None, ),  # 4
