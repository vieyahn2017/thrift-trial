...
class Insanity(object):
    ...
    thrift_spec = (
        ...
        (2, TType.LIST, 'xtructs', (TType.STRUCT, (Xtruct, Xtruct.thrift_spec), False), None, ),  # 2
    )
...
class CrazyNesting(object):
    ...
    thrift_spec = (
        ...
        (2, TType.SET, 'set_field', (TType.STRUCT, (Insanity, Insanity.thrift_spec), False), None, ),  # 2
        (3, TType.LIST, 'list_field', (TType.MAP, (TType.SET, (TType.I32, None, True), TType.MAP, (TType.I32, None, TType.SET, (TType.LIST, (TType.MAP, (TType.STRUCT, (Insanity, Insanity.thrift_spec), TType.STRING, 'UTF8', True), True), False), False), False), False), None, ),  # 3
...
class SomeUnion(object):
    ...
    thrift_spec = (
        ...
        (3, TType.I32, 'i32_thing', None, None, ),  # 3
        (4, TType.STRUCT, 'xtruct_thing', (Xtruct3, Xtruct3.thrift_spec), None, ),  # 4
        (5, TType.STRUCT, 'insanity_thing', (Insanity, Insanity.thrift_spec), None, ),  # 5
    )
...
class ListBonks(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.LIST, 'bonk', (TType.STRUCT, (Bonk, Bonk.thrift_spec), False), None, ),  # 1
    )
...
class NestedListsBonk(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.LIST, 'bonk', (TType.LIST, (TType.LIST, (TType.STRUCT, (Bonk, Bonk.thrift_spec), False), False), False), None, ),  # 1
    )
