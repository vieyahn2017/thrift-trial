...
class CrazyNesting(object):
    ...
    thrift_spec = (
        ...
        (3, TType.LIST, 'list_field', (TType.MAP, (TType.SET, (TType.I32, None, True), TType.MAP, (TType.I32, None, TType.SET, (TType.LIST, (TType.MAP, (TType.STRUCT, (Insanity, Insanity.thrift_spec), TType.STRING, None, True), True), False), False), False), False), None, ),  # 3
